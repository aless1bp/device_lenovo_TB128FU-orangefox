...
# ===== SCREEN SPECIFICATIONS (Portrait 1200x2000 @ 240 DPI, rotated 180) =====
...
# ===== OTA SUPPORT =====
# Note: Block OTA updates not compatible with VANILLA builds
export OF_SUPPORT_ALL_PAYLOAD_OTA_UPDATES=1
# export OF_SUPPORT_ALL_BLOCK_OTA_UPDATES=1  # Disabled - incompatible with FOX_VANILLA_BUILD
